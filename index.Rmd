...
Despite the book never being completed, I do want to share what we created as far as it got. It's got some good material and some really handy associated [online exercises](https://nhcooper123.github.io/pcm-primer-online/index.html) that I've been sharing with people for years. I thought it'd be good to give them a DOI so people can actually cite the damn things. Thus this gitbook was born. It isn't perfect, in particular its not very well referenced and its focus is on older foundational methods rather than the myriad new methods available, but it's done. I hope some of you find it useful :).
