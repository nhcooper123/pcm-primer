--- 
title: "Primer on Phylogenetic Comparative Methods for the Biological Sciences"
...
[TO BE COMPLETED]
The *Primer* is divided into eight chapters as follows:
...
[TO BE COMPLETED]
Each chapter of the *Primer* has associated online companion material. This consists of 
...
```{block, type="info"}
**FYI** boxes. These boxes highlight important details that we don't want you to miss!
```
