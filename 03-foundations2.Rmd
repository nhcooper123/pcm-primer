...
Finally, it's rare to see such simple examples of Brownian motion across trees as we've shown here. You're much more likely to see something like Figure \@ref(fig:phytools), drawn using the phytools R package. We also don't fit the models using the simple maths we've shown you above as it gets quite time consuming, instead we use Maximum Likelihood. Don't worry about this for now as we will return to it later in the book.
...
![rhodos](images/rhododendrons.jpg)
