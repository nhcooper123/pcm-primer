...
![A Brownie in Motion. Brownie Credit: Ɱ. License: CC BY-SA 3.0](images/brownie.png)
</center>
...
```{block, type = "detail"}
Not all implementations of the OU model actually estimate $\mu$. In some implementations (see [online materials](https://nhcooper123.github.io/pcm-primer-online/cont.html#models-of-evolution-for-continuous-traits)) $\mu$ is equivalent to $z(0)$, the starting value of the trait. 
```
...
```{r crab1, echo = FALSE, fig.cap="Simulations showing how the claw size of crabs changes through time under a Brownian model with z(0) = 20 mm and sigma^2 = 0.1 (black lines) and an OU model with z(0) = 20 mm, sigma2 = 0.1, mu = 20 mm and alpha = 0.1 (red lines)", out.width='80%', fig.asp=".75", fig.align='center'}
...
![*Phylloscopus sibilatrix*. Credit: Stevie Garvie. License: CC BY-SA 2.0](images/warbler.jpg)
</center>

$$\\[0.1cm]$$

An adaptive radiation is essentially defined as a group of species that have originated from a common ancestor, with associated ecological diversification into a range of ecological niches [@losos2003niche]. *Phyllscopus* warblers are a genus of small insectivorous passerines that breed across Europe and Asia. It is not unusual for several species to occur sympatrically (i.e. live in the same place), therefore it has been hypothesised that ecological differences underpin the radiation. Price and colleagues have studied the radiation of this and other similar species in several landmark studies (e.g. [@rich1992evolution],  [@price2014niche]).  

<center>
![Figure 5.4: Ecology and the adaptive radiation of *Phylloscopus* warblers. (a) The phylogeny of the group. (b) The niche space of the radiation, measured by prey size and beak size of each species. The numbers correspond to the nodes in (a). (c) A dataset generated randomly according to the niche-filling model described above.](images/niche2.png)
</center>
...
Model adequacy is equally important for models of trait evolution. Simulating data under the Brownian model will generate null distributions [@boettiger2012your] and allow straightforward assessment of model fit, for example by generating appropriate critical values for Likelihood ratio tests. Boettiger et al 2012 [@boettiger2012your] discuss this at length and other papers use similar approaches [@martins1991phylogenetic], [@freckleton2002phylogenetic].
...
<center>
\begin{equation}
  AICw_{i} = \frac{e^{-0.5 \Delta AIC_i}}{\Sigma(e^{-0.5 \Delta AIC})}
\end{equation}
</center>
...
- Presents a very thorough account of OU models: Cooper, Natalie, Gavin H. Thomas, Chris Venditti, Andrew Meade, and Rob P. Freckleton. 2016. “A Cautionary Note on the Use of Ornstein-Uhlenbeck Models in Macroevolutionary Studies.” Biological Journal of the Linnaean Society in press [@cooper2016]. But also see the reply to this paper: Grabowski et al 2023 [@grab2023].
- To learn more about fitting models of evolution: O’Meara, Brian C, Cécile Ané, Michael J Sanderson, and Peter C Wainwright. 2006. “Testing for Different Rates of Continuous Trait Evolution Using Likelihood.” Evolution 60 (5): 922–33. [@o2006testing]
...
- For discussions of model adequacy in these kinds of models: Boettiger, Carl, Graham Coop, and Peter Ralph. 2012. “Is Your Phylogeny Informative? Measuring the Power of Comparative Methods.” Evolution 66 (7): 2240–51. [@boettiger2012your]

## Online exercises

- [Preparing your tree and data for PCMs in R](https://nhcooper123.github.io/pcm-primer-online/prep.html)
- [Models of evolution for continuous traits](https://nhcooper123.github.io/pcm-primer-online/cont.html)
- [Models of evolution for discrete traits](https://nhcooper123.github.io/pcm-primer-online/discrete.html)
- [Beyond simple macroevolutionary models](https://nhcooper123.github.io/pcm-primer-online/beyond.html)