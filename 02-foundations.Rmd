...
```{r basic-tree, echo = FALSE, fig.cap='All of these phylogenies show the same species relationships, they are just presented in different ways', out.width='80%', fig.asp=.75, fig.align='center'}

# basic 4 species phylogeny
...
```{r ultrametric, echo = FALSE, fig.cap='All of these phylogenies show the same species relationships, they are just presented in different ways', out.width='80%', fig.asp=.75, fig.align='center'}
...
```{r polytomy, echo = FALSE, fig.cap='All of these phylogenies show the same species relationships, they are just presented in different ways', out.width='80%', fig.asp=.75, fig.align='center'}
...
par(mfrow = c(2, 3))
plot(shorebird.tree, type = "p", no.margin = TRUE)
plot(shorebird.tree, type = "c", no.margin = TRUE)
plot(shorebird.tree, type = "fan", no.margin = TRUE)
plot(shorebird.tree, type = "p", no.margin = TRUE, direction = "upwards")
plot(shorebird.tree, type = "p", no.margin = TRUE, direction = "downwards")
plot(shorebird.tree, type = "p", no.margin = TRUE, direction = "leftwards")
par(mfrow = c(1, 1))
```
