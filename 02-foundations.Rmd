...
```{r diff-trees, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = 'All of these phylogenies show the same species relationships, they are just presented in different ways', out.width='80%', fig.asp=.75, fig.align = 'center'}
