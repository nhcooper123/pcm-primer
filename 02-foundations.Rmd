...
```{r phyly, echo = FALSE, fig.cap='Monophyly', out.width='80%', fig.asp=.75, fig.align='center'}
...
# Plot
(p + px) / (pxx+pxxx) / (p1 + p1) / (p1xx+p1xxx)  
...
```{r fan-tree, echo = FALSE, fig.cap = 'All of these phylogenies show the same species relationships, they are just presented in different ways', out.width='80%', fig.asp=.75, fig.align = 'left'}
