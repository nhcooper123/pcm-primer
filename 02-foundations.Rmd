...
```{r basic-tree, echo = FALSE, fig.cap='A simple phylogeny demonstrating the key features all phylogenies share. Tips are images rather than species names.', out.width='80%', fig.asp=.75, fig.align='center'}
