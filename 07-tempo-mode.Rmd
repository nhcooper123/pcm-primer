...
We return to this later in this chapter, but often when people investgiate models of evolution they fit multiple models and compare them, and then select the "best" model (see below). Often in these scenarios, OU is favoured. For example, Harmon et al (2010) looked at XX phylogenies and found XX% favoured the OU model (over Brownian and Early burst models; see below). When we do this, however, the OU model may actually be favoured for non-biological reasons. The two most important issues are: 
